...
public class ApplicationConfiguration {
    ...
    public UserDetailsService userDetailsService() {
        return username -> userRepository.findByEmailAddress(username).orElseThrow(() -> new RecordNotFoundException("User with such email does not exist, or wrong password."));
    }
